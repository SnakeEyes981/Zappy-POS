    ...
    return (
        ...
        <div className="order-card basis-1/4 rounded-xl bg-white/85 hover:bg-white transition p-4 md:shrink-0">
            <div className="flex flex-col items-center gap-y-4">
                ...
                <div className="flex md:flex-row flex-col justify-between md:items-center text-sm font-bold w-full text-center gap-y-2 md-gap-y-0">
                    <p className="tableNumber bg-emerald-300 rounded-full px-4 py-2">Table 4</p>
                    <p className="orderStatus bg-yellow-300 rounded-full px-4 py-2">In Progress</p>
                </div>
            </div>
        </div>
        </>
