        ...
        <>
            <nav className="text-white flex md:flex-row flex-col md:gap-y-0 gap-y-4 justify-between items-center">
                ...
                <div className="flex md:flex-row flex-col md:gap-y-0 gap-y-4 md:w-auto md:gap-x-4 gap-x-0 w-full">
                    <div className="bg-stone-800 border-stone-600 border sm:rounded-full rounded-lg flex sm:flex-row flex-col justify-between gap-x-2">
                    ...
                    <div className="bg-stone-800 border-stone-600 border sm:rounded-full rounded-lg">
